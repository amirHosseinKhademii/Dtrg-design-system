      ...
      <Controller
        ...
        render={({
          ...
          <div className="w-full flex-col relative">
            {props.label && (
              <label className="text-light dark:text-dark">{props.label}</label>
            )}
            <div
              onClick={() => toggle()}
              className={classNames(
                'w-full row-between focus:outline-none overflow-hidden cursor-pointer  bg-white dark:bg-gray-400 mt-2 ',
                open
            ...
            <Error error={error} className="absolute top-[70px] left-0" />
          </div>
        )}
      />
